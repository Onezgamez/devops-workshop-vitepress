...
**Deelnemer Naam:** `Zeno Raymaekers`  
**Workshop Datum:** `27/11/2025`  
**Doel:** `Mijn eerste CI/CD pipeline bouwen`  
**GitHub Gebruikersnaam:** `Onezgamez`  
**Verwachte Site URL:** `https://Onezgamez.github.io/devops-workshop-vitepress/`
...
- [x] Live site geverifieerd op: `https://onezgamez.github.io/devops-workshop-vitepress/`
...
**Definitieve Site URL:** `https://onezgamez.github.io/devops-workshop-vitepress/`  
**Repository URL:** `https://github.com/Onezgamez/devops-workshop-vitepress`  
**Voltooiingsdatum:** `27/11/2025 14:20`
